...
/**
 * Table officielle Dofus : XP cumulée nécessaire pour être au niveau donné,
 * indexée par niveau (index 0 = niveau 0 avec 0 XP, index 100 = niveau 100 avec
 * 196 159 XP). Vérifiée pour chaque transition de niveau (0 → 1 = 1 XP, etc.).
 */
export const PET_XP_BY_LEVEL: number[] = [
  0, 1, 2, 3, 5, 7, 9, 11, 13, 15, 18, 21, 24, 28, 32, 37, 42, 48, 54, 61,
  70, 79, 89, 100, 113, 128, 144, 162, 182, 204, 228, 255, 285, 318, 355, 396,
  441, 492, 548, 609, 675, 749, 830, 920, 1019, 1134, 1260, 1398, 1550, 1709,
  1882, 2080, 2296, 2533, 2793, 3089, 3409, 3760, 4145, 4567, 5023, 5528, 6081,
  6687, 7351, 8102, 8919, 9811, 10787, 11843, 12974, 14214, 15570, 17051, 18667,
  20645, 22699, 24946, 27399, 30072, 32672, 35745, 39103, 42767, 46761, 51452,
  56385, 61775, 67650, 74044, 80678, 88200, 96395, 105300, 115160, 126018,
  137715, 150478, 164402, 179591, 196159,
];

/** XP totale au niveau 100 d'un familier (valeur cible par défaut). */
export const DEFAULT_MAX_XP = 196159;
